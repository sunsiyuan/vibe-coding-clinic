 ...
 * 观众项目展示墙 · 自动生成脚本
 *
 * 扫描 episodes/ 下各场次，从 README.md 的 YAML frontmatter 读取信息，
...
<body>
  <header class="wall-header">
    <img class="clinic-logo" src="clinic-logo.png" alt="孙哥的 AI 急诊时间" />
    <h1>孙哥的 AI 急诊时间 · 观众项目墙</h1>
    <p class="sub">连线观众的 AI 项目集合 · 共 ${projects.length} 个</p>
  ...
  <script>
    ...
    document.getElementById('wall').innerHTML = projects.map(p => {
      ...
      const recapEl = recapItems ? '<details class="card-recap"><summary>AI急诊时间复盘</summary><div class="recap-body">' + recapItems + '</div></details>' : '';
